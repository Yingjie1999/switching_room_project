...
def Point_thirty_five(file_name1, file_name2):
    Point_info = []
    results1 = img35_1(file_name1)
    # result_imgs = img35_2(file_name2)
...
if __name__ == '__main__':
    img1_path = './images3/37-1.JPG' # Need to modify!!
    img2_path = './images3/37-2.JPG' # Need to modify!!
    results1 = img35_1(img1_path)
    print(results1)
    results2 = img35_2(img2_path)
