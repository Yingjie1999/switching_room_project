...
def img36_2(file_path):
    ...
    # 确定合闸压板位置,检测情况
    box1 = np.array([x-3*r, y+3*r, x+3*r, y+9*r])
...
def Point_thirty_six(file_name1, file_name2):
    Point_info = [ '合闸指示', '储能指示', '分闸指示', '合闸按钮', '合闸压板', '分闸按钮']
    result_imgs = img36_1(file_name1)
    #cv2_show#('result', result_imgs)
    results2 = img36_2(file_name2)
    # results2['电压1'] = str(0)
    # results2['电压2'] = str(0)
    # results2['电压3'] = str(0)
    # results2['电压4'] = str(0)
...
if __name__ == '__main__':
    img1_path = './images2/36-1.JPG'
    img2_path = './images2/36-2.JPG'
    Point_info = [ '合闸指示', '储能指示', '分闸指示', '合闸按钮', '合闸压板', '分闸按钮']
    result_imgs = img36_1(img1_path)
    #cv2_show#('result', result_imgs)
    results2 = img36_2(img2_path)
    # results2['电压1'] = str(0)
    # results2['电压2'] = str(0)
    # results2['电压3'] = str(0)
    # results2['电压4'] = str(0)
