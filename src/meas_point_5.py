...
def instruct_led_recogn(img):
    ...
    circles = cv2.HoughCircles(canny, cv2.HOUGH_GRADIENT, 1, 200, param1=150, param2=30, minRadius=50,
...
# def Point_five(file_name1, file_name2):
...
#
#     print("point_five:",Point_list)
#
#
#     return tran(Point_list)
def Point_five(img_path, code_info):
