...
def Point_thirty_nine(file_name1, file_name2):
    Point_info = []
    results1 = img39_1(file_name1)
    result_imgs = img39_2(file_name2)
    #cv2_show#('result', result_imgs)
    # results1['电流'] = dispatchNum_recog(result_imgs)
    print(results1)
    Point_list = list(results1.values())
    print("Point_39:", Point_list)
    # cv2.waitKey(0)
    # cv2.destroyAllWindows()
    return Point_list

if __name__ == '__main__':
    img1_path = './images3/39-1.JPG'
    img2_path = './images3/39-2.JPG'
    results1 = img39_1(img1_path)
    print(results1)
