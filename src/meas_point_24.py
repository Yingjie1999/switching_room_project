...
def b_w_key_split(img):
    ...
    circles = cv2.HoughCircles(image_er, cv2.HOUGH_GRADIENT, 1, 300, param1=300, param2=30, minRadius=0,
    ...
    if circles is not None:
        ...
        img_return_area = [circles1[0][0] - circles1[0][2] * 2 + split_w, circles1[0][1] - circles1[0][2] * 2 + split_h,
...
def Point_twenty_four(file_name1, file_name2):
    ...
    b_w_key_img, b_w_key_area = b_w_key_split(img2)
...
#     file_name1 = 'C:\\Users\\SONG\\desktop\\images2\\1-1.JPG'
#     file_name2 = 'C:\\Users\\SONG\\desktop\\images2\\1-2.JPG'
#     cv2.waitKey(0)
